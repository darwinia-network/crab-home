      ...
      <section className="pt-8 pt-md-12">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-md-10 col-lg-8 text-center">
              {/* Heading */}
              <h2 className="fw-bold">Kusama Parachain Slot Auction</h2>

              {/* Text */}
              <p className="fs-lg text-muted mb-9">
                Crab will participate in the Kusama Parachain Slot Auction.
                Obtaining slots will help the Crab Network to be better. We need
                more support to ensure the success of the auction, and you will
                get rewards.
              </p>
            </div>
          </div>
              ...
              <div className="card card-border border-primary shadow-lg mb-6 mb-md-8 lift lift-lg">
                <div className={`card-body text-center ${styles.minH450}`}>
                  ...
                  <div className="text-white mb-5">
                    ...
                    <img
                      src="../../img/crab/home-action-1.png"
                      alt="..."
                      width="130px"
                    />
                  </div>
                  ...
                  {/*  Heading */}
                  <h4 className="fw-bold">What is Parachain Slot Auctions</h4>

                  {/*  Text */}
                  <p className="text-gray-700 mb-5">
                    Kusama is a multi-chain network. All parachains are
                    connected to Kusama through slots. Since the initial number
                    of slots is small, it needs to be obtained through auctions.
                  </p>

                  {/*  Badge */}
                  <span className="badge rounded-pill bg-dark-soft">
                    <a href="https://guide.kusama.network/docs/en/mirror-learn-auction">
            ...
            <div className="col-12 col-md-6 col-lg-4">
              ...
              <div className="card card-border border-primary shadow-lg mb-6 mb-md-8 lift lift-lg">
                <div className={`card-body text-center ${styles.minH450}`}>
                  ...
                  <div className="text-white mb-5">
                    <img
                      src="../../img/crab/home-action-2.png"
                      alt="..."
                      width="130px"
                    />
                  </div>
                  ...
                  {/*  Heading */}
                  <h4 className="fw-bold">What is Crowdloan</h4>

                  {/*  Text */}
                  <p className="text-gray-700 mb-5">
                    In order to obtain a slot, Crab Network will launch
                    Crowdloan to allow the community to participate together to
                    increase the probability of success while users' KSMs will
                    not leave away from their wallets.
                  </p>

                  {/*  Badge */}
                  <span className="badge rounded-pill bg-dark-soft">
                    <a href="https://guide.kusama.network/docs/en/mirror-learn-crowdloans">
                      <span className="h6 text-uppercase">Learn more</span>
                    </a>
                  </span>
                </div>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              ...
              <div className="card card-border border-primary shadow-lg mb-6 mb-md-8 lift lift-lg">
                <div className={`card-body text-center ${styles.minH450}`}>
                  ...
                  <div className="text-white mb-5">
                    <img
                      src="../../img/crab/home-action-3.png"
                      alt="..."
                      width="130px"
                    />
                  </div>
                  ...
                  {/*  Heading */}
                  <h4 className="fw-bold">You will get generous rewards</h4>

                  {/*  Text */}
                  <p className="text-gray-700 mb-5">
                    Participating users will get generous rewards even if the
                    auction fails.
                  </p>
